package com.scu.smartgrocerytracker.login;
...
import com.scu.smartgrocerytracker.welcome.WelcomeFragment;
    ...
    private void resolveSignInError() {
        if (mGoogleConnectionResult.hasResolution()) {
            try {
                ...
                mGoogleConnectionResult.startResolutionForResult(this, WelcomeFragment.RC_GOOGLE_LOGIN);
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    if (!mGoogleIntentInProgress) {
                        ...
                        startActivityForResult(recover, WelcomeFragment.RC_GOOGLE_LOGIN);
                    }
